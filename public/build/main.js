...
var ChatClient = function(options) {
  ...
  // connects to socket, sets response listeners
    ...
    // heroku
    // self.socket = io.connect('https://chjat.herokuapp.com/', { transports: ['websocket'] } );
